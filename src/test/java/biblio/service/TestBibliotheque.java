...
public class TestBibliotheque {
	...
	public void before() {
		...
		empruntDao= spring.getBean(biblio.repository.EmpruntRepository.class );
	...
	public void ajouterLivre() {
		try {
			...
			Assert.assertEquals((Long.valueOf(bibliotheque.getMaxLivreIdentique())), livreDao.countByTitreAndAuteur("L'�tranger","Albert Camus"));
	...
	public void retirerLivre() {
		try {
			...
			Assert.assertEquals(Long.valueOf(0l),  livreDao.countByTitreAndAuteur("Stupeur et tremblements","Am�lie Nothomb"));
